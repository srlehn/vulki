// Package registration provides experimental FFT-based image registration
...
// reference implementation. WithBackend can require either backend, while
// WithDevice borrows an existing root Device without closing it. A Correlator
// owns the resources it creates; callers must close it when it is no longer
// needed.
//
